          ...
          <section className="navWrapper wrapper">
            <div className="navBreadcrumb wrapper">
              <div className="navToggle" id="navToggler">
                <img
                  alt="menu"
                  src={this.props.config.baseUrl + this.props.config.menubar}
                />
              </div>
              <h2>
                <span>
                  <a href={this.props.config.baseUrl}>home</a>
                </span>
                <i>-</i>
                <span>
              ...
              {siteConfig.onPageNav === 'separate' && (
                <div className="tocToggler" id="tocToggler">
                  <img
                    alt="menu"
                    src={this.props.config.baseUrl + this.props.config.menumore}
                  />
                </div>
              )}
            </div>
